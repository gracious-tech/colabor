    ...
    routes: [
        ...
        {path: '/admin', component: () => import('./comp/routes/admin/AdminContainer.vue'), children: [
            ...
            {path: 'fundraisers/:fundraiser', component: () => import('./comp/routes/admin/AdminFundraiser.vue'), children: [
                ...
                {path: 'statements', component: () => import('./comp/routes/admin/AdminStatements.vue')},
                {path: 'statements/:statement', name: 'statement',
                    component: () => import('./comp/routes/admin/AdminStatement.vue')},
            ]},
        ]},
