...
import currency_bitcoin from '@material-symbols/svg-400/outlined/currency_bitcoin.svg?component'
import credit_card from '@material-symbols/svg-400/outlined/credit_card.svg?component'
